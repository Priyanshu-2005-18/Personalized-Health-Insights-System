...
from app.recommendation_engine.rules import ALL_RULE_SETS
...
from app.recommendation_engine.services.scorer import (
...
def _rank_recommendations(recs: List[Recommendation]) -> List[Recommendation]:
    from app.recommendation_engine.rules.thresholds import CATEGORY_WEIGHTS
