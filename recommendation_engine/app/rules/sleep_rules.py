"""
rules/sleep_rules.py
====================
Rule-based sleep recommendations.

Each rule is a function that receives HealthMetrics and returns a
Recommendation (or None if the rule does not fire).

Rule firing conditions use SLEEP thresholds from thresholds.py.
Rules are evaluated in severity order — most critical first.
"""
...
from app.rules.thresholds import SLEEP
...
# Registry — evaluated in order (most severe first)
SLEEP_RULES = [
