"""
rules/stress_rules.py
=====================
Rule-based stress reduction recommendations.
"""
...
from app.rules.thresholds import SLEEP, STRESS
...
def rule_high_stress(m: HealthMetrics) -> Optional[Recommendation]:
    ...
    # Compound rule: stress + poor sleep is particularly damaging
    compound_note = ""
