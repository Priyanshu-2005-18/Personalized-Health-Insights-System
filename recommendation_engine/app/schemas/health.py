...
schemas/health.py
=================
Pydantic v2 schemas — FastAPI request validation and response serialisation.
These mirror the dataclasses in models/health.py but add:
  - Field-level validation with custom error messages
  - JSON examples for /docs
  - Serialisation aliases where needed
"""
...
# ─────────────────────────────────────────────────────────────────────────────
#  Utility: convert domain models → response schemas
# ─────────────────────────────────────────────────────────────────────────────
